...
def get_scores(reference_list: list,
    ...
    file_name = "/mnt/Data/akashghosh/MDS/Data/" + "MDS_TI_vgg_.csv"
    val_df.to_csv(file_name, index=False) 
    count=0
    met=0
    bleu_1=0

...
def train(model,
    ...
    for epoch in range(MAX_EPOCHS):
        ...
        path = "./Model/Model_TI_encoder_decoder_image_fusion"
...
NewDataset_path = '/mnt/Data/akashghosh/MDS/Data/multimodal_final_updated.csv'
#Dataset = pd.DataFrame(read_json_data(NewDataset_path))
Dataset=pd.read_csv(NewDataset_path)
